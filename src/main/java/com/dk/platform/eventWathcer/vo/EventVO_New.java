...
@Slf4j
@NoArgsConstructor
public class EventVO_New {

	private static String CLASS_NAME = EventVO_New.class.getSimpleName();
	 ...
	 */
	@Builder
	public EventVO_New(String messageID, String destname, String hostName, long timeStamp, byte[] payload, int thresholdSR) {
