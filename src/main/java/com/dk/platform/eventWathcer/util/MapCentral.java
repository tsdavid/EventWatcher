...
public class MapCentral {
	 ...
	 *
	 */
	private ConcurrentHashMap<String, EventVO> Memory_Store = null;		// ====> MemoryStorage
	
	
	/**
	 * Number of Reporting Thread.
	 */
	private Integer Numof_ReportManager = 0;	 // Have to Over than Reporting Content. ==> Config
